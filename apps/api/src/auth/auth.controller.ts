import { Controller, Post, Body, Res, Req, UseGuards, HttpCode, UnauthorizedException } from '@nestjs/common';
...
const COOKIE_OPTS = { httpOnly: true, sameSite: 'lax' as const, path: '/api/auth/refresh' };
